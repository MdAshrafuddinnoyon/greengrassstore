  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-[88px] sm:bottom-24 right-3 sm:right-6 z-[60] flex items-center group"
      ...
      >
        ...
        <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="white"
