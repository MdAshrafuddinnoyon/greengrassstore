  ...
  return (
    ...
    >
      <AnimatePresence>
        {isHovered && (
          <motion.span
            ...
            exit={{ opacity: 0, x: 20 }}
            className="mr-3 bg-white px-4 py-2 rounded-lg shadow-lg text-sm font-medium text-gray-700"
          >
            Chat with us
          </motion.span>
        )}
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/30"
      >
        <svg
