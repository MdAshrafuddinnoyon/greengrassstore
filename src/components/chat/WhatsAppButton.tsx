...
export const WhatsAppButton = ({ message }: WhatsAppButtonProps) => {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-32 right-6 z-[60] w-80 bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100"
          >
            {/* Header */}
      ...
      {/* Floating Button - Positioned above Sales Agent button */}
      <motion.button
        ...
        className="fixed bottom-24 right-6 z-[60] flex items-center group"
      ...
      >
        ...
        <div className="relative w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="white"
